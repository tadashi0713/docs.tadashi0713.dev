...
filesystem you can share with containers. For details about accessing the setting, see [File sharing](https://docs.docker.com/manuals/desktop/settings#file-sharing).
