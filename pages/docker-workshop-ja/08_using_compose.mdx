[Docker Compose](https://docs.docker.com/manuals/compose/) is a tool that helps you define and
...
In [part 7](./07_multi_container), you used the following command to start the application service.
...
Related information:
 - [Compose overview](https://docs.docker.com/manuals/compose/)
