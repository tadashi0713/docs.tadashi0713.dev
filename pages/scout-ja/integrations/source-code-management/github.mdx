...
このような状況が発生すると、Docker Scout はその差異を検出し、[最新のベースイメージポリシー](https://chatgpt.com/manuals/scout/policy/_index.md#up-to-date-base-images-policy)を通じて通知します。GitHub 統合が有効化されていると、ベースイメージの更新に関する自動的な提案も受けられます。Docker Scout がどのようにしてサプライチェーンのセキュリティ対策を自動的に改善できるかについては、[修正](https://chatgpt.com/policy/remediation.md)を参照してください。
